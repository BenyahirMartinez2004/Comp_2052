...
from wtforms import StringField, PasswordField, EmailField,SubmitField  # Importamos los campos necesarios para el formulario.
...
class RegisterForm(FlaskForm):
    ...
    correo = EmailField("Correo", validators=[DataRequired(), Email()])  # Campo correo, obligatorio y con formato válido.
